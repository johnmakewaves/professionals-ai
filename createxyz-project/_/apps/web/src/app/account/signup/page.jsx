    ...
    <div className="min-h-screen bg-white dark:bg-[#121212] flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#1E1E1E] dark:text-white mb-2">Create Account</h1>
          <p className="text-[#70757F] dark:text-[#A8ADB4]">Join AI Expert Hub to connect with AI professionals</p>
        </div>
